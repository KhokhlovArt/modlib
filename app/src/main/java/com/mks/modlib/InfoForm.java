...
public class InfoForm {
    ...
    //Метод проверки можно ли запускать прилождение
    public boolean check() {
        ...
        if (result) {
            //Приложение установлено - Не показываем лендинг
            //Log.e("!!!", "it's ok");
        } else {
            show();
        }
    ...
    private void init(Context context, Activity a) {
        ...
        String htmlString = Service.getLending(modName);
    ...
    public class WebAppInterface {
        ...
        public void download(String param) {
            ...
            Service.setWebViewLending(Service.getLoadLending(modName), webView, mAct);
