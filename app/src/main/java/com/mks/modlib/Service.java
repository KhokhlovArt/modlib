...
public class Service {
    ...
    /*******************************************************************************************
     /*   Лендинги
     ********************************************************************************************/
    public static String getLoadPercentLending(String mod_name, int percent)
    {
        return "<!DOCTYPE html>\n" +
                "<html lang=\"ru\">\n" +
                "<head>\n" +
    ...
    public static String getLoadLending(String mod_name)
    {
        return  "<!DOCTYPE html>\n" +
                "<html lang=\"ru\">\n" +
                "<head>\n" +
    ...
    //Метод получения лендинга
    public static String getLending(String mod_name)
    {
        return "<!DOCTYPE html>\n" +
                "<html lang=\"ru\">\n" +
                "<head>\n" +
...
//                "  \n" +
//                "  <div>\n" +
//                "    <button onClick=\"exit('1');\"> Закрыть! </button>\n" +
//                "    \n" +
//                "    <button onClick=\"download('1');\"> Скачать! </button>\n" +
//                "  </div>\n" +
//                "\n" +
//                "  </body>\n" +
//                "</html>";
